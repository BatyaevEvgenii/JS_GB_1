/* ******************************** */
// Задание 8
// 1. Замыкания в скрипте basket.js пологаю пока не применить
...
// Выводилось бы значение переменной "а" равно 1(true), но раз есть отрицание то и результат будет false-undefined
...
b(1, 2, 3);
// выдаст во всплывающем окне 10. т.к. функция вернет вторым индексом значение 10
