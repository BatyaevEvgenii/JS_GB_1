/* ******************************** */
// Задание 8
// 1. Замыкания в скрипте basket.js пологаю на этом этапе пока не применить
...
alert(a);
// т.к. стоит отрицание(!), то и результат должен быть противоположный. 
// Выводилось бы значение переменной "а" равно 1 (true), но раз есть отрицание то и результат видимо будет false-undefined

var b = function a(x) { 
  x && a(--x);
}; 
alert(a);
// выдаст ошибку, т.к. переменнная "а" - ни где не определена

function a(x) { return x * 2;
}
var a; 
alert(a);
// ошибки не будет, ибо переменная "а" определена. А что выведете? Может быть то что в {...}
...
b(1, 2, 3);
// выдаст во всплывающем окне 10, т.к. в функции будет замещение второго индекса значением 10

function a() { 
  alert(this);
} 
a.call(null);
// что-то выведет, но не ошибку
